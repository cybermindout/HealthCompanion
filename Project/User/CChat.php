    ...
    <body>
                    ...
                    <div class="nav-start">
                        <div class="recipient-block">
                            <div class="avatar-container">
                                <img class="user-avatar" src="../Assets/FILES/counsellorPhoto/<?php echo $_GET["img"] ?>" alt="">
                            </div>
                            <div class="username">
        ...
        <script>
                                    ...
                                    function sendChat(id)
                                    {
                                        ...
                                        if (chat.length <= 35)
                                        {
                                            $.ajax({url: "CAjaxChat.php?chat=" + chat+"&id="+id,
                                    ...
                                    $(document).ready(function() {
                                        setInterval(function() {
                                            $("#conversation").load('CLoad.php?id=<?php echo $_GET["did"] ?>')
                                        }, 50);
                                    });
