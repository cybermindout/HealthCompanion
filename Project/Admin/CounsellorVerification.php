...
if(isset($_GET["aid"]))
{
	$accept="update tbl_counsellor set counsellor_status=1 where counsellor_id='".$_GET["aid"]."'";
...
?>
<script>
		window.location="counsellorVerification.php";
</script>
    <?php
	}
}
...
<form id="form1" name="form1" method="post" action="">
  <table border="1" cellpadding="10" style="border-collapse:collapse">
    ...
    <?php
	$i=0;
	$selD="select * from tbl_counsellor d inner join tbl_place p on p.place_id=d.place_id inner join tbl_district ds on ds.district_id=p.district_id where counsellor_status=0";
  ...
  <td><a href="../Assets/FILES/counsellorProof/<?php echo $dataD["counsellor_proof"]?>" target="_blank">
      ...
      <td><?php echo $dataD["counsellor_proof"]?></td>
      <td><?php echo $dataD["counsellor_dob"]?></td>
      <td><?php echo $dataD["district_name"]?></td>
      <td><?php echo $dataD["place_name"]?></td>
      <td><a href="CounsellorVerification.php?aid=<?php echo $dataD["counsellor_id"]?>">Accept</a>/<a href="CounsellorVerification.php?rid=<?php echo $dataD["counsellor_id"]?>">Reject</a></td>
    </tr>
    <?php
	}
	?>
