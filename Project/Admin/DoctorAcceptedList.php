...
if(isset($_GET["rid"]))
{
	...
	{
		header("Location:DoctorAcceptedList.php");
	}
}
...
<form id="form1" name="form1" method="post" action="">
  <table border="1" cellpadding="10">
    ...
    <?php
	$i=0;
	$selD="select * from tbl_doctor d inner join tbl_place p on p.place_id=d.place_id inner join tbl_district ds on ds.district_id=p.district_id inner join tbl_speacialization s on s.speacialization_id=d.specialization_id where doctor_status=1";
    ...
    <tr>
      ...
      <td><a href="DoctorAcceptedList.php?rid=<?php echo $dataD["doctor_id"]?>">Reject</a></td>
    </tr>
    <?php
	}
	?>
