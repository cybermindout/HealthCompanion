...
if(isset($_GET["aid"]))
{
	...
	{
		header("Location:DoctorVerification.php");
	}
}
if(isset($_GET["rid"]))
{
...
<form id="form1" name="form1" method="post" action="">
  <table border="1" cellpadding="10" >
    ...
    <?php
	$i=0;
	$selD="select * from tbl_doctor d inner join tbl_place p on p.place_id=d.place_id inner join tbl_district ds on ds.district_id=p.district_id inner join tbl_speacialization s on s.speacialization_id=d.specialization_id where doctor_status=0";
    ...
    <tr>
      ...
      <td><a href="DoctorVerification.php?aid=<?php echo $dataD["doctor_id"]?>">Accept</a>/<a href="DoctorVerification.php?rid=<?php echo $dataD["doctor_id"]?>">Reject</a></td>
    </tr>
    <?php
	}
	?>
