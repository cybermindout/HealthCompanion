...
<form id="form1" name="form1" method="post" action="">
  <table border="1" cellpadding="10">
    ...
    <?php
	$i=0;
	$selD="select * from tbl_counsiler d inner join tbl_place p on p.place_id=d.place_id inner join tbl_district ds on ds.district_id=p.district_id where counsiler_status=2";
    ...
    <tr>
      ...
      <td><a href="CounsilerVerification.php?aid=<?php echo $dataD["counsiler_id"]?>">Accept</a></td>
    </tr>
    <?php
	}
	?>
